...
func _run() -> void:
	...
	_assert(compose.contains("Allow Location permission to use your current location"), "permission error copy")
	...
	_assert(preset.contains("version/name=\"0.1.28-current-location-qr-camera-fix\""), "version name 27")
