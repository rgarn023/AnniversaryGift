...
func _test_search_architecture() -> void:
	...
	_assert(main.contains("Location Lock ·") or main.contains("location locked"), "preview location wording")
	...
	_assert(main.contains("ScrollLockEvaluator") or main.contains("Location Lock"), "locked details checklist")
	...
	_assert(compose_full.contains("Attachments removed from active product UI"), "attachments removed from active UI")
	...
	_assert(viewer.contains("_parchment_root") or viewer.contains("_content_rect"), "fixed parchment content root")
...
func _test_version() -> void:
	...
	_assert(
		preset.contains("ChestOfLoveNotes-v46-chest-geometry-grounding-debug.apk") or preset.contains("ChestOfLoveNotes-v45-chest-grounding-scroll-fix-debug.apk") or preset.contains("ChestOfLoveNotes-v44-chest-render-scroll-beach-polish-debug.apk")
	...
	_assert(
		preset.contains("version/code=46") or preset.contains("version/code=45")
