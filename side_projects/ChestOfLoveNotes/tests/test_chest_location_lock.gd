...
func _test_search_architecture() -> void:
	...
	_assert(main.contains("This scroll is location locked"), "preview location wording")
...
func _test_version() -> void:
	...
	_assert(preset.contains("ChestOfLoveNotes-location-lock-online-debug.apk"), "APK name")
	_assert(preset.contains("version/code=16"), "export 16")
