...
func _run() -> void:
	...
	## VERSION
	_assert(flags.contains("APP_VERSION_CODE := 42") or flags.contains("APP_VERSION_CODE := 41") or flags.contains("APP_VERSION_CODE := 40") or flags.contains("APP_VERSION_CODE := 39") or flags.contains("APP_VERSION_CODE := 35") or flags.contains("APP_VERSION_CODE := 34"), "versionCode 34+")
	_assert(preset.contains("version/code=42") or preset.contains("version/code=41") or preset.contains("version/code=40") or preset.contains("version/code=39") or preset.contains("version/code=38") or preset.contains("version/code=35") or preset.contains("version/code=34"), "export 34+")
	_assert(
