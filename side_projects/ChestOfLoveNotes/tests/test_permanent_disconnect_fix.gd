...
func _run() -> void:
	...
	## VERSION
	_assert(flags.contains("APP_VERSION_CODE := 53") or flags.contains("APP_VERSION_CODE := 52") or flags.contains("APP_VERSION_CODE := 51") or flags.contains("APP_VERSION_CODE := 50") or flags.contains("APP_VERSION_CODE := 49") or flags.contains("APP_VERSION_CODE := 48") or flags.contains("APP_VERSION_CODE := 47") or flags.contains("APP_VERSION_CODE := 42") or flags.contains("APP_VERSION_CODE := 41") or flags.contains("APP_VERSION_CODE := 40") or flags.contains("APP_VERSION_CODE := 39") or flags.contains("APP_VERSION_CODE := 35") or flags.contains("APP_VERSION_CODE := 34"), "versionCode 34+")
