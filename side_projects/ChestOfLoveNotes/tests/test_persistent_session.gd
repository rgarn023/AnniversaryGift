...
func _test_demo_disabled_online_build() -> void:
	...
	_assert(preset.contains("version/code=19") or preset.contains("version/code=17") or preset.contains("version/code=15"), "versionCode bumped")
...
func _test_anniversary_gift_untouched() -> void:
	...
	_assert(BuildFlags.APP_VERSION_CODE >= 19, "COLN versionCode incremented for send/map/preview/picker")
