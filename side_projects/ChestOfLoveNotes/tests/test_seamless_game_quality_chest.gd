...
func _run() -> void:
	...
	_assert(preset.contains("version/code=62"), "export 62")
	_assert(preset.contains("0.1.62-free-parrot-runtime"), "version name")
	_assert(preset.contains("v62-free-parrot-runtime-debug.apk"), "APK name")
