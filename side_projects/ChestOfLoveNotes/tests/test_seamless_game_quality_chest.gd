...
func _run() -> void:
	...
	_assert(flags.contains("APP_VERSION_CODE := 63"), "versionCode 63")
	_assert(preset.contains("version/code=63"), "export 63")
	_assert(preset.contains("0.1.63-parrot-visible-fix"), "version name")
