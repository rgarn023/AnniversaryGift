...
func _run() -> void:
	...
	_assert(gitignore.contains("ChestOfLoveNotes-backend-location-qr-splash-fix-debug.apk"), "APK allowlisted in gitignore")
	_assert(preset.contains("backend-location-qr-splash-fix-debug.apk"), "export_path APK name")
