...
func _test_build_version() -> void:
	...
	_assert(preset.contains("ChestOfLoveNotes-preview-activity-focus-notifications-debug.apk"), "export APK name")
	_assert(preset.contains("version/code=19"), "export versionCode 18")
