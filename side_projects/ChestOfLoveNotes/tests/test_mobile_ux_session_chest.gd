...
func _test_build_version() -> void:
	...
	_assert(preset.contains("ChestOfLoveNotes-current-location-qr-camera-fix-debug.apk"), "export APK name")
	_assert(preset.contains("version/code=28"), "export versionCode 26")
