...
func _test_build_version() -> void:
	...
	_assert(preset.contains("ChestOfLoveNotes-splash-timing-chest-animation-fix-debug.apk"), "export APK name")
	_assert(preset.contains("version/code=32"), "export versionCode 32")
