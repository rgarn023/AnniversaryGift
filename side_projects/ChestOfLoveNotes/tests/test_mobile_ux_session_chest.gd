...
func _test_build_version() -> void:
	...
	_assert(
		preset.contains("ChestOfLoveNotes-v74-auth-recovery-google-signin-debug.apk")
		or preset.contains("auth-recovery-google-signin")
		or preset.contains("ChestOfLoveNotes-v61-baked-scroll-reveal-debug.apk")
		or preset.contains("splash-timing-chest-animation-fix-debug.apk"),
		"export APK name"
	)
	_assert(
		preset.contains("version/code=74")
		or preset.contains("version/code=73")
		or preset.contains("version/code=61")
		or preset.contains("version/code=32"),
		"export versionCode recent"
	)
