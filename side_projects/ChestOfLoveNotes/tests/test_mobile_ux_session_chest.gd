...
func _test_build_version() -> void:
	...
	_assert(preset.contains("ChestOfLoveNotes-time-location-map-preview-selfsend-fixes-debug.apk"), "export APK name")
	_assert(preset.contains("version/code=22"), "export versionCode 22")
