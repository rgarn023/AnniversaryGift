...
func _test_build_version() -> void:
	...
	_assert(preset.contains("ChestOfLoveNotes-backend-location-qr-splash-fix-debug.apk"), "export APK name")
	_assert(preset.contains("version/code=30"), "export versionCode 26")
