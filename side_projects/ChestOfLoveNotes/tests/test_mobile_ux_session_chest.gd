...
func _test_build_version() -> void:
	...
	_assert(preset.contains("ChestOfLoveNotes-android-bridges-compose-qr-fix-debug.apk"), "export APK name")
	_assert(preset.contains("version/code=29"), "export versionCode 26")
