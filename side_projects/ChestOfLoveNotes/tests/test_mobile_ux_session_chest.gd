...
func _test_build_version() -> void:
	...
	_assert(preset.contains("ChestOfLoveNotes-send-map-preview-picker-fixes-debug.apk"), "export APK name")
	_assert(preset.contains("version/code=18"), "export versionCode 18")
