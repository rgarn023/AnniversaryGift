...
func _test_build_version() -> void:
	...
	_assert(preset.contains("ChestOfLoveNotes-preview-radius-attachments-debug.apk"), "export APK name")
	_assert(preset.contains("version/code=17"), "export versionCode 16")
