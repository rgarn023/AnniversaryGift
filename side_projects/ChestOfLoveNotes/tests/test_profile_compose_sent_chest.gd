...
func _test_chest_empty_and_new_scroll_contracts() -> void:
	...
	_assert(chest.contains("_apply_open_amount"), "continuous lid open amount")
	_assert(chest.contains("LID_OPEN_SCALE_Y"), "2.5D lid foreshortening")
...
func _test_main_wiring() -> void:
	...
	_assert(BuildFlags.APP_VERSION_CODE >= 14, "versionCode bumped for this fix pass")
