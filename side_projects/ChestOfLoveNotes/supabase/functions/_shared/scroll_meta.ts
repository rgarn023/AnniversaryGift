...
export function recipientScrollSafe(args: {
  ...
  return {
    ...
    activity_lock_enabled: Boolean(args.scroll.activity_lock_enabled),
    activity_target_km: Number(args.scroll.activity_target_km ?? 0),
    focus_lock_enabled: Boolean(args.scroll.focus_lock_enabled),
    focus_duration_hours: Number(args.scroll.focus_duration_hours ?? 0),
    is_read: isRead,
